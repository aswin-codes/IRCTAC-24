                    ...
                    <table className='text-sm sm:text-lg w-full'>
                        <tbody>
                            <tr className='border-y-8 border-transparent'>
                                <td className='w-56 text-right font-bold whitespace-nowrap'><p className='mr-2 sm:mr-10'>3rd June 2024</p></td>
                            ...
                            <tr className='border-y-8 border-transparent'>
                                <td className='w-56 text-right font-bold whitespace-nowrap'><p className='mr-2 sm:mr-10'>1st September 2024</p></td>
                                <td className='w-8'><div className="w-4 h-4 rounded-full bg-purple-600 mx-auto"></div></td>
                                <td className='text-left'><p className='ml-2 sm:ml-10 w-fit'>Paper submission deadline</p></td>
                            </tr>
                            <tr className='border-y-8 border-transparent'>
                                <td className='w-56 text-right font-bold whitespace-nowrap'><p className='mr-2 sm:mr-10'>30th September 2024</p></td>
                                <td className='w-8'><div className="w-4 h-4 rounded-full bg-purple-600 mx-auto"></div></td>
                                <td className='text-left'><p className='ml-2 sm:ml-10 w-fit'>Acceptance notification</p></td>
                            </tr>
                            <tr className='border-y-8 border-transparent'>
                                <td className='w-56 text-right font-bold whitespace-nowrap'><p className='mr-2 sm:mr-10'>15th October 2024</p></td>
                                <td className='w-8'><div className="w-4 h-4 rounded-full bg-purple-600 mx-auto"></div></td>
                                <td className='text-left'><p className='ml-2 sm:ml-10 w-fit'>Camera Ready Copy submission</p></td>
                            </tr>
                            <tr className='border-y-8 border-transparent'>
                                <td className='w-56 text-right font-bold whitespace-nowrap'><p className='mr-2 sm:mr-10'>5th November 2024</p></td>
                                <td className='w-8'><div className="w-4 h-4 rounded-full bg-purple-600 mx-auto"></div></td>
                                <td className='text-left'><p className='ml-2 sm:ml-10 w-fit'>Registration Close</p></td>
                            </tr>
                            <tr className='border-y-8 border-transparent'>
                                <td className='w-56 text-right font-bold whitespace-nowrap'><p className='mr-2 sm:mr-10'>14th-15th November 2024</p></td>
                                <td className='w-8'><div className="w-4 h-4 rounded-full bg-purple-600 mx-auto"></div></td>
