...
const Navbar = () => {
    ...
    return (
        <div className={`fixed w-full max-w-[1440px] z-10 ${isOpen && 'h-full lg:h-auto'} `}>
            <div className='flex backdrop-blur-sm bg-transparent px-10 py-5 items-center justify-between w-full'>
                ...
                <div className='lg:hidden'>
                    {
                        !isOpen ?
                            <div onClick={() => setIsOpen(true)}> <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-8">
                                <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5" />
                            </svg></div> : <div onClick={() => setIsOpen(false)}><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-8">
