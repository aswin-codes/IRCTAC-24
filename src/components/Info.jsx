    ...
    <div className='px-5 sm:px-8 lg:px-20 py-5 sm:py-10 w-full max-w-[1440px] mx-auto'>
      ...
      <div className='mt-16 grid grid-cols-1 md:grid-cols-2 gap-10'>
        ...
        <div className='flex flex-col items-center text-center info-item'>
          ...
          <p>Day 1 Detailed Schedule: <span className='underline cursor-pointer'><a href='#'>Click here</a></span></p>
          <p>Day 2 Detailed Schedule: <span className='underline cursor-pointer'><a href='#'>Click here</a></span></p>
        </div>
        <div className='flex flex-col items-center text-center info-item'>
          <h1 className='text-morange text-lg sm:text-2xl font-semibold'>ICRTAC-2024 Conference Schedule</h1>
          <p>For complete schedule details: <span className='underline cursor-pointer'><a href='#'>Click here</a></span></p>
        </div>
        <div className='flex flex-col items-center text-center info-item'>
          <h1 className='text-morange text-lg sm:text-2xl font-semibold'>Offline Presentation Track Details</h1>
          <p>For Date, Time and Venue details: <span className='underline cursor-pointer'><a href='#'>Click here</a></span></p>
        </div>
      </div>
    </div>
  )
